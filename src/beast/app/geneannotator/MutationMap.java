...
public class MutationMap {
    ...
    public boolean containsVariantSite(final VariantSiteInfo var) {
        if (!Objects.equals(this.chromosome, var.getChromosomeLabel()))
            return false;

        return this.startPos <= var.getPosition() && var.getPosition() <= this.endPos;
    }
