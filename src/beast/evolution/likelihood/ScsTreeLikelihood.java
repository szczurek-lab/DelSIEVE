...
import beast.evolution.rawreadcountsmodel.RawReadCountsModelFiniteMu;
import beast.evolution.rawreadcountsmodel.RawReadCountsModelFiniteMuDel;
...
public class ScsTreeLikelihood extends ScsGenericTreeLikelihood {
    ...
    protected void variablesSanityCheck() {
        if ((substitutionModel instanceof ScsFiniteMuExtendedModel) && (!(rawReadCountsModel instanceof RawReadCountsModelFiniteMu)))
            throw new IllegalArgumentException("Error! 'rawReadCountsModelInput' should be of type 'RawReadCountsModelFiniteMu', rather than " +
        ...
        if ((substitutionModel instanceof ScsFiniteMuDelModel) && (!(rawReadCountsModel instanceof RawReadCountsModelFiniteMuDel)))
